...
export default function Features3() {
  const features = [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1633265486064-086b219458ec?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1618482914248-29272d021005?q=80&w=1372&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          ...
          <div className="features-item-wrap">
            <div className="row justify-content-center">
              {features?.map((feature, index) => (
                <div
                  key={index}
                  className="col-xl-4 col-md-6 features-container"
                >
                  <div
