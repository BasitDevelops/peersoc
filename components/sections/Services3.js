                  ...
                  >
                    <div className="services-item-three">
                      ...
                      <div className="services-content-three">
                        ...
                        <p>
                          PeerSOC provides round-the-clock monitoring to
                          identify and respond to threats quickly, minimizing
                  ...
                  >
                    <div className="services-item-three">
                      ...
                      <div className="services-content-three">
                        <div className="section-title mb-30">
                          <h2 className="title">
                            Bringing New IT Business 2 Solutions And Ideas
                          </h2>
                        </div>
                        <p>
                          Our team is equipped to respond immediately to
                          incidents, perform forensic analysis, and mitigate
                          damage.
                        </p>
                        <div className="services-list">
                          <ul className="list-wrap">
